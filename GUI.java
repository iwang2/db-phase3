...
public class GUI {
    ...
    private void initialize() {
        ...
        JPanel view_reviews = new JPanel();
        ...
        regis_btn_regis.addActionListener(e -> {
            ...
            else if(false) {                                        //CHECK FOR USER ID UNIQUENESS
        ...
        //PASSENGER LANDING*********************************************************************************************************************************************************************************
        JLabel passland_lbl_welcome = new JLabel("Welcome ");
        ...
        JButton passland_btn_writerev = new JButton("Write Review");
		...
		leaverev_drop_station.setModel(new DefaultComboBoxModel(stations));
        ...
        JLabel viewrev_lbl_name = new JLabel("'s Reviews");         //ADD USERS NAME
        viewrev_lbl_name.setBounds(26, 28, 532, 33);
        view_reviews.add(viewrev_lbl_name);

		JList viewrev_list = new JList();
		viewrev_list.setModel(new AbstractListModel() {
			String[] values = new String[] {"QUERY"};//INSERT VALUES OF REVIEWS
			public int getSize() {
		...
		viewrev_list.setBounds(26, 103, 127, 323);
		view_reviews.add(viewrev_list);
		...
		statinfo_drop_station.setModel(new DefaultComboBoxModel(stations));
		...
		linesum_drop_station.setModel(new DefaultComboBoxModel(stations));
        ...
        editprof_first.setText("First Name");                                           //INPUT USERS FIRST NAME
        ...
        editprof_last.setText("Last Name");                                              //INPUT USERS LAST NAME
        ...
        editprof_email.setText("Email");                                                //INPUT USERS EMAIL
        ...
        editprof_userid.setText("User ID");                                             //INPUT USERS ID
        ...
        editprof_pass.setText("Password");                                              //INPUT USERS PASSWORD
        ...
        editprof_passagain.setText("Password (again)");                                 //INPUT USERS PASSWORD AGAIN
		...
		go_drop_station.setModel(new DefaultComboBoxModel(stations));
		...
		updatetrip_drop_endstat.setModel(new DefaultComboBoxModel(stations));
        ...
        //ADMIN LANDING**************************************************************************************************************************************************************************************
        JLabel adland_lbl_welcome = new JLabel("Welcome "+userid);
		...
		addstat_drop_line.setModel(new DefaultComboBoxModel(lines));
		...
		addline_drop_station.setModel(new DefaultComboBoxModel(stations));
		...
		linesumad_drop_linename.setModel(new DefaultComboBoxModel(lines));
		...
		statinfoad_drop_statname.setModel(new DefaultComboBoxModel(stations));
